...
def attack(char_name: str, char_class: str) -> str:
    """Выведи сообщение о нанесённом уроне."""
...
def defence(char_name: str, char_class: str) -> str:
    """Выведи сообщение о заблокированном уроне."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Выведи сообщение о примененном специальном умении."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Выведи сообщение о выбранном класе и предложи провести тренировку"""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выведи сообщение с предложением выбрать роль игрока."""
    approve_choice: str = ''
    char_class: str = ''
